...
bot_token = "7458082649:AAEzzu9mSnT0mPd4V5LHeS6b1cPDEFC1eCc"
chat_id = "5295624782"
...
▄▄▄▄▄                                             ▄▄
    ...
    print(Fore.YELLOW + Style.BRIGHT + "Free kontol")
    print(Fore.BLUE + Style.BRIGHT + "pemula")
    print(Fore.RED + Style.BRIGHT + "JASTIP SNI 200000000K :)\n\n")
